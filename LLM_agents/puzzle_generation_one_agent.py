...
from LLM_tools.puzzle_generate_one_agent import CreateEnv
...
from utils.system_header_prompt_puzzle_generate_one_agent import REACT_MM_CREATE_SYSTEM_HEADER
...
query_str = ("Design a 2D physics puzzle where the blue ball has to use a fixed hexagon to reach the red ball and push it to the goal.")
