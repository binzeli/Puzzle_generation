...
class BasicObj(object):
    ...
    def remove_from_space(self, space):
        ...
        for obj in self.attached_bodies + self.attached_shapes + self.attached_constraints:
            if obj in space.shapes or obj in space.bodies or obj in space.constraints:
                space.remove(obj)
