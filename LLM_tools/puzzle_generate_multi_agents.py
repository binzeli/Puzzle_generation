...
class CreateEnv(BaseToolSpec):
    def __init__(self):
        ...
        try:
            ...
            pass
        #self.visualization_path = "/home/bili/Desktop/gen_env_llm_new2/other_images/env10.jpg"
    ...
    spec_functions = ["place_red_ball_blue_ball_goal", "place_floor", "place_wall", "call_designer", "call_solver", "adjust_red_ball_position", "adjust_goal_position",
    ...
    def call_designer(self, prompt):
        """
        This function helps you call the designer tool to design a new puzzle.

        Args:
        prompt: The prompt given to the designer based on current situation.
        """
        print('ball_message:', self.ball_message)
        return design(prompt, self.ball_message)
    ...
    # def visualize(self,**kwargs) -> Visualization:
    #     """
    #     This function helps you visualize the current state of the game environment.
    #     It provides a JSON of the game objects as well as the corresponding image of the game environment with all of the objects placed.
    ...
    #     if self.env_json['name'].endswith("Tool"):
    #         self.tool_visualized = True
    #         env.step(self.action)
        
    #     if self.env_json['name'].endswith("Start"):
    #         explanation_str = "we will use the blue marker ball to push the red target ball towards the right, where it will fall off the platfrom going right, i.e. towards (0,0)"

    #     frame = env.render('rgb_array_high_mega_changed_colors')
    #     Image.fromarray(frame).save(self.visualization_path)
    #     env.close()

    #     return Visualization(json_str=json.dumps(self.env_json),image_documents=[ImageDocument(image_path=self.visualization_path)],explanation_str=explanation_str)
    ...
    def visualize_simulation(self):
        ...
        return self.tool_message, message
