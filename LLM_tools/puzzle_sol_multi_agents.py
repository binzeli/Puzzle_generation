...
class CreateEnv(BaseToolSpec):
    ...
    spec_functions = ["place_ramp", "visualize_simulation", 'place_fixed_hexagon', 'place_cannon','adjust_tool', 'plan_next_tool']
    ...
    def place_ramp(self, first_obj, direction1, second_obj, direction2, ball_moving_direction):
        """
        ...
        Pass a string for the direction the ball should be moving toward: 'left', 'right'
    ...
    def plan_next_tool(self):
        tools_pos = json.dumps(self.tools)
        message = tools_pos + self.tool_message + self.ball_message
